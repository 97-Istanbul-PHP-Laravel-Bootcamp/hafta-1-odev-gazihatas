...
<div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Hakkımızda<strong>Sayfası</strong></h2>    			    				    				
					<div id="gmap">
					</div>
				</div>		
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-10">
                            <div class="about-image-wrap">
                                <img style="border-radius:200px;" src="Admin/resimler/hakkimizda/<?php echo  $hakkimizdacek['hakkimizda_resim'] ?>" width="600px" heigth="600px" alt="Hakkimizda-resiö" />

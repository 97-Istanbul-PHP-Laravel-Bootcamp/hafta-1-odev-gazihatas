...
<head>
  ...
  <title>Admin | Mahallenden İste</title>
...
<body style="background-color: #7952B3" class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
  <figure>
        <img src="resimler/logo/Mahallemden_logo.png" alt="" width="250px" heigth="250px" style="border-radius: 125px;">
    </figure>
    <a style="color:white" href="../../index2.html"><b style="color:white">Admin </b>Girişi</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
